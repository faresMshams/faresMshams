...
try:
    ...
    views_button = driver.find_element(By.XPATH, '/html/body/div[6]/div/div[2]/div/div/div[6]/div/button')    
    # Click on views button and enter URL
    views_button.click()
    url_input = driver.find_element(By.XPATH, '/html/body/div[10]/div/form/div/input')
    url_input.send_keys(url)
    print('URL entered')
    time.sleep(1)
    
    # Click on the submit button
    search_key = driver.find_element(By.XPATH, '/html/body/div[10]/div/form/div/div/button')
    time.sleep(1.5)
    search_key.click()
    time.sleep(3.5)
    ...
    while True:
        try:
            ...
            submit_key = driver.find_element(By.XPATH, '//*[@id="c2VuZC9mb2xeb3dlcnNfdGlrdG9V"]/div[1]/div/form/button')
            submit_key.click()
            time.sleep(5)
            
            # Print the result of the submit action Successfully 1000 views sent.
            result_element = WebDriverWait(driver, 10).until(
                EC.visibility_of_element_located((By.XPATH, '//*[@id="c2VuZC9mb2xeb3dlcnNfdGlrdG9V"]/span[2]'))
            )
